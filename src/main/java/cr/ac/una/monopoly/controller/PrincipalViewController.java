...
public class PrincipalViewController extends Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        imageJ2 = "/cr/ac/una/monopoly/resources/circuloVerde.png";
        ...
        if (rut != null) {
            if (rut.getRuta1() != null) {
                ...
                imageJ1 = rut.getRuta1();
                imageJ2 = rut.getRuta2();

            }
        }

        Image imageB = new Image(imageJ1);
        ImVJugador1.setImage(imageB);
        Image imageA = new Image(imageJ2);
        ImVJugador2.setImage(imageA);
